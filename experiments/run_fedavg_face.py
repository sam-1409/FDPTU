...
def trainer_fn(model, loader):
    ...
    return ClientTrainer(model, optimizer, device=DEVICE)

metric_logger = MetricLogger(
    "/content/drive/MyDrive/FDPTU/results/face_fedavg_metrics.json"
)
...
server = FederatedServer(
    ...
    method_name="FedAvg-Face"
)

server.train()
torch.save(
    server.global_model.state_dict(),
    "/content/drive/MyDrive/FDPTU/checkpoints/fedavg_face.pt"
)